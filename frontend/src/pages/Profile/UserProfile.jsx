  ...
  return (
    <>
      ...
      <div className="flex min-h-screen bg-gray-50 pt-20">
        ...
        {/* NEW LAYOUT WRAPPER: 
          This pushes everything (Main Content AND Footer) to the right 
          of the 260px fixed Material-UI sidebar so nothing gets hidden.
        */}
        <div className="flex-1 md:ml-[260px] flex flex-col min-h-[calc(100vh-80px)]">
          
          {/* Main content takes up available vertical space with flex-1 */}
            ...
            <section className="mb-8 bg-white rounded-3xl shadow-sm pb-8">
              ...
              <div className="relative flex flex-col md:flex-row items-end md:items-center gap-6 -mt-16 px-8">
                <div className="w-32 h-32 rounded-2xl border-4 border-white overflow-hidden shadow-lg bg-white z-10 flex-shrink-0">
                  <img 
                    src={`https://ui-avatars.com/api/?name=${getDisplayName(user)}&background=15803d&color=fff&size=128`} 
                    alt="Profile Avatar" 
                    className="w-full h-full object-cover" 
                  />
                </div>
          ...
          {/* FOOTER IS NOW INSIDE THE WRAPPER - It will sit perfectly at the bottom right! */}
          <Footer />
        </div>
      </div>
    </>
